...
* dev-python/textual                   - [6.7.1]            -- Python framework to build sophisticated UI
...
* games-strategy/unciv-bin             - [4.18.19]           -- Civ V remake for Android & Desktop
...
* net-misc/ytsurf                      - [3.0.2]            -- Simple shell script to search for YouTube videos from your terminal
