...
* dev-python/textual                   - [5.2.0]            -- Python framework to build sophisticated UI
...
* net-misc/ytsurf                      - [1.6.0]            -- Simple shell script to search for YouTube videos from your terminal
