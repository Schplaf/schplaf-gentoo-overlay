...
* app-text/epy                         - [2023.6.11]        -- A fork of epr, a CLI Ebook Reader
...
* dev-python/install-playwright-python - [1.0.0-r1]         -- Execute `playwright install` from Python
...
* dev-vcs/gitstats                     - [0_pre20201124-r2] -- Statistics generator for git [temporary ebuild, until the official one is updated]
* dev-vcs/vcstool                      - [0.3.0-r1]         -- Tool designed to make working with multiple repositories easier
* games-strategy/unciv-bin             - [4.20.20]          -- Civ V remake for Android & Desktop
...
* net-misc/PostDad                     - [0.3.1]            -- A Terminal UI (TUI) for testing APIs
* net-misc/reddit-tui                  - [0.3.9]            -- Terminal UI for reddit
* net-misc/ytsurf                      - [3.1.7]            -- Simple shell script to search for YouTube videos from your terminal
