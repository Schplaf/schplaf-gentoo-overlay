...
* dev-python/textual                   - [5.0.1]            -- Python framework to build sophisticated UI
...
* net-misc/gophertube                  - [2.5.1]            -- A modern TUI for searching and watching YouTube videos using mpv and chafa
* net-misc/ytsurf                      - [1.5.0]            -- Simple shell script to search for YouTube videos from your terminal
