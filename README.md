...
* dev-cpp/tabular                      - [1.5.0]            -- Lightweight, header-only C++ library for creating well-formatted, fully-customizable CLI tables.
...
* dev-python/textual                   - [7.3.0]            -- Python framework to build sophisticated UI
...
* games-strategy/unciv-bin             - [4.19.6_p1]        -- Civ V remake for Android & Desktop
...
* net-misc/ytsurf                      - [3.0.8]            -- Simple shell script to search for YouTube videos from your terminal
