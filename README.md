...
* dev-python/textual                   - [7.5.0]            -- Python framework to build sophisticated UI
...
* games-strategy/unciv-bin             - [4.19.13]          -- Civ V remake for Android & Desktop
...
* net-misc/ytsurf                      - [3.1.3]            -- Simple shell script to search for YouTube videos from your terminal
